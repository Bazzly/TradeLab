...
- Setup B (Opening Range Breakout scalp, `bot.md` Section 1.2) is spec-only — deferred to keep this a reviewable increment rather than doubling scope in one pass.
